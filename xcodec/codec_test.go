...
import (
	...
	"github.com/go-board/x-go/xcodec/internal"
	"github.com/go-board/x-go/xcodec/xgob"
	"github.com/go-board/x-go/xcodec/xjson"
	"github.com/go-board/x-go/xcodec/xproto"
	"github.com/go-board/x-go/xcodec/xtoml"
	"github.com/go-board/x-go/xcodec/xyaml"
)
