...
// Package xnet provides network utility functions, complementing the more
...
// LimitedListener returns a Listener that accepts at most n simultaneous
...
// acquired.
func (l *limitedListener) acquire() bool {
	select {
	case <-l.done:
		return false
	case l.sem <- struct{}{}:
